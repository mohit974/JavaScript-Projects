...
document.addEventListener("keydown", function (e) {
  if (e.key.toLowerCase() === "q" && p2.health > 0 && game.isOver == false) {
    p1.strike(p1, p2, p1.attackDmg);
...
document.addEventListener("keydown", function (e) {
  if (e.key.toLowerCase() === "a" && p2.health > 0) {
    p1.heal(p1);
...
document.addEventListener("keydown", function (e) {
  if (e.key.toLowerCase() === "p" && p1.health > 0 && game.isOver == false) {
    p2.strike(p2, p1, p2.attackDmg);
...
document.addEventListener("keydown", function (e) {
  if (e.key.toLowerCase() === "l" && p2.health > 0) {
    player2.heal(p2);
